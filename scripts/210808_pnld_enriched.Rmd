---
title: "210808_pineland_enriched"
...
```{r, include = FALSE}
dat <- read_csv("data/210808_pineland_a_e/210808_pineland_enriched_O2.csv", skip = 1)
head(dat)
#View(dat)
...
dat_2 <- dat %>%
  ...
  mutate(
    ...
    tank_channel == "Tank 2_1" ~ "7",
    tank_channel == "Tank 2_2" ~ "9",
    tank_channel == "Tank 2_3" ~ "11",
    tank_channel == "Tank 2_4" ~ "13",
    tank_channel == "Tank 3_1" ~ "3",
    tank_channel == "Tank 3_2" ~ "4",
    tank_channel == "Tank 3_3" ~ "10",
    tank_channel == "Tank 3_4" ~ "16",
...
ggsave("plots/210808_pineland_ambient_enriched/210808_pineland_enriched_DO_conc_plot.png", plot = DO_conc_plot, width = 10, height = 7)
...
ggsave("plots/210808_pineland_ambient_enriched/210808_pineland_enriched_temp_plot.png", plot = temp_plot, width = 10, height = 7)
...
ggsave("plots/210808_pineland_ambient_enriched/210808_pineland_enriched_DO_mass_plot.png", plot = DO_mass_plot, width = 10, height = 7)
...
htmlwidgets::saveWidget(as_widget(p), "plots/210808_pineland_ambient_enriched/210808_pineland_enriched_DO_mass_plot.html")
...
## the linear portion of the NEP curve is roughly from minute 26 to minute 92 ##

pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 92)
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 92)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 92)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 92)
...
pnld_e_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 92)
...
pnld_e_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 92)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 92)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 92)
...
pnld_e_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 92)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 92)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 92)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 92)
...
pnld_e_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 92)
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 92)
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 92)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 26 & delta_T_min <= 92)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 92)
...
write_csv(dat_final, "data/210808_pineland_a_e/210808_pnld_enriched_rates.csv")
```