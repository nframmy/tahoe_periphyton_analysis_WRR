...
## the linear portion of the NEP curve is roughly from minute 32 to minute 116 ##

pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_2 <- dat_full %>%
  filter(chamber == "2" & delta_T_min >= 150 & delta_T_min <= 200)
...
pnld_e_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_3 <- dat_full %>%
  filter(chamber == "3" & delta_T_min >= 150 & delta_T_min <= 200)
...
## the linear portion of the NEP curve is roughly from minute 32 to minute 118 ##

pnld_e_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 32 & delta_T_min <= 118)
...
pnld_e_5 <- dat_full %>%
  filter(chamber == "5" & delta_T_min >= 150 & delta_T_min <= 200)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 32 & delta_T_min <= 118)
...
pnld_e_11 <- dat_full %>%
  filter(chamber == "11" & delta_T_min >= 150 & delta_T_min <= 200)
...
pnld_e_1 <- dat_full %>%
  filter(chamber == "1" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_7 <- dat_full %>%
  filter(chamber == "7" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_8 <- dat_full %>%
  filter(chamber == "8" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_12 <- dat_full %>%
  filter(chamber == "12" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_6 <- dat_full %>%
  filter(chamber == "6" & delta_T_min >= 130)
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_9 <- dat_full %>%
  filter(chamber == "9" & delta_T_min >= 130)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_14 <- dat_full %>%
  filter(chamber == "14" & delta_T_min >= 130)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_15 <- dat_full %>%
  filter(chamber == "15" & delta_T_min >= 130)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_4 <- dat_full %>%
  filter(chamber == "4" & delta_T_min >= 130)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_10 <- dat_full %>%
  filter(chamber == "10" & delta_T_min >= 130)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_13 <- dat_full %>%
  filter(chamber == "13" & delta_T_min >= 130)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 32 & delta_T_min <= 116)
...
pnld_e_16 <- dat_full %>%
  filter(chamber == "16" & delta_T_min >= 130)
...
write_csv(dat_final, "data/220227_pineland_a_e/220227_pnld_enriched_rates.csv")
```
